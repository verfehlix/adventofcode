...
lineReader.on('close', function () {
    ...
    while (i < instructions.length) {
    	...
    	i += instructions[i]
    	// if the last instruction was >= 3, decrease instruction where we just were by 1
    	// else add 1 to instruction where we just were
	    instructions[lasti] >= 3 ? instructions[lasti]-- : instructions[lasti]++
