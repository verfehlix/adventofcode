...
// after were done redistributing, check after how many cycles our duplicate is found again
const duplicate = memHistory[memHistory.length - 1]
const indexOfFirstDuplicate = memHistory.indexOf(duplicate)
const indexOfSecondDuplicate = memHistory.length - 1
const diff = indexOfSecondDuplicate - indexOfFirstDuplicate
console.log("Duplicate found again after " + diff + " cycles.")
